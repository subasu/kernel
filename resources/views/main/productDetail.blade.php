                        ...
                        <div class="primary-box row">
                            ...
                            <div class="pb-left-column col-xs-12 col-sm-5">
                                ...
                                <div class="product-image">
                                    ...
                                    <!-- product-imge-->
                                        <img id="product-zoom" src="{{url('public/dashboard/productFiles/picture/'.$product->productImages[0]->image_src)}}"
                                    ...
                                    <div class="product-img-thumb" id="gallery_01">
                                        <ul class="owl-carousel" data-items="3" data-nav="true" data-dots="false"
                                            ...
                                            <li>
                                                <a href="#" data-image="{{url('public/dashboard/productFiles/picture/'.$img->image_src)}}"
