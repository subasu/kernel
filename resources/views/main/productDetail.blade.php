    ...
    <div class="columns-container">
        <div class="container" id="columns">
            ...
            <div class="breadcrumb clearfix">
                ...
                <a href="#" title="Return to Home">@php $brand=$product->categories[0]->id;
               $subcat =  \App\Models\Category::where('id','=',$brand)->value('parent_id');
               $subcat =  \App\Models\Category::where('id','=',$subcat)->value('parent_id');
               $cat =  \App\Models\Category::where('id','=',$subcat)->value('title');
               echo $cat;
                    @endphp</a>
                <span class="navigation-pipe">&nbsp;</span>
                <a href="#" title="Return to Home">@php $brand=$product->categories[0]->id;
               $subcat =  \App\Models\Category::where('id','=',$brand)->value('parent_id');
               $subcat =  \App\Models\Category::where('id','=',$subcat)->value('title');
               echo $subcat;
                    @endphp</a>
                <span class="navigation-pipe">&nbsp;</span>
                        ...
                        <div class="primary-box row">
                            <div class="pb-right-column col-xs-12 col-sm-7 ">
                                ...
                                <div class="product-price-group">
                                    <span class="price">@foreach($product->productFlags as $flag)
                                            @if($flag->active == 1)
                                ...
                                <div class="form-option">
                                    ...
                                    @if(!empty($product->sizes))
                                        <div class="attributes">
                                            <div class="attribute-label">اندازه:</div>
                            ...
                            <div class="pb-left-column col-xs-12 col-sm-5">
                                ...
                                <div class="product-image">
                                    <div class="product-full">
                                        <img id="product-zoom"
                                             src="{{url('public/main/assets/data/product-s3-420x512.jpg')}}"
                                             data-zoom-image="{{url('public/main/assets/data/product-s3-850x512.jpg')}}"/>
                                    </div>
                                    <div class="product-img-thumb" id="gallery_01">
                                        <ul class="owl-carousel" data-items="3" data-nav="true" data-dots="false"
                                            ...
                                            <li>
                                                <a href="#" data-image="public/main/assets/data/product-s3-420x512.jpg"
                                                   data-zoom-image="public/main/assets/data/product-s3-850x1036.jpg">
                                                    <img id="product-zoom"
                                                         src="{{url('public/main/assets/data/product-s3-100x122.jpg')}}"/>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-image="public/main/assets/data/product-s2-420x512.jpg"
                                                   data-zoom-image="public/main/assets/data/product-s2-850x1036.jpg">
                                                    <img id="product-zoom"
                                                         src="{{url('public/main/assets/data/product-s2-100x122.jpg')}}"/>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-image="public/main/assets/data/product-420x512.jpg"
                                                   data-zoom-image="public/main/assets/data/product-850x1036.jpg">
                                                    <img id="product-zoom"
                                                         src="{{url('public/main/assets/data/product-100x122.jpg')}}"/>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-image="public/main/assets/data/product-s4-420x512.jpg"
                                                   data-zoom-image="public/main/assets/data/product-s4-850x1036.jpg">
                                                    <img id="product-zoom"
                                                         src="{{url('public/main/assets/data/product-s4-100x122.jpg')}}"/>
                                                </a>
                                            </li>
