                            ...
                            <div class="container">
                                ...
                                <div class="col-md-10 col-md-offset-1 margin-1">
                                    <div class="col-md-7 col-sm-6 col-xs-9 col-md-offset-2">
                                        <input disabled id="lastCategory" class="form-control col-md-12" name="lastCategory" value="{{$products[0]->categories[0]->title}}">
                                    ...
                                    <div id="grandparent">
                                        <div class="col-md-7 col-sm-6 col-xs-9 col-md-offset-2">
                                            <div class="col-md-2 col-md-offset-3">
                                                <a type="button" name="edit" id="edit" class="glyphicon glyphicon-edit btn btn-success edit"
                                                   products-toggle=""
                                                   title="ویرایش "></a>
                                            </div>
                                                <input disabled id="editable" class="form-control col-md-12 col-xs-12 editable" name="title" type="text" value="{{$products[0]->title}}">
                                            </div>
                                ...
                                <div class="col-md-10 col-md-offset-1 margin-1">
                                    <div id="grandparent">
                                        <div class="col-md-7 col-sm-6 col-xs-9 col-md-offset-2">
                                            ...
                                            <textarea  style="text-align: right; direction: ltr;" disabled id="editable"  class="form-control col-md-12 col-xs-12 overflow-x editable"  name="description" required="required" >
                                    ...
                                    <div id="grandparent">
                                        <div class="col-md-7 col-sm-6 col-xs-9 col-md-offset-2">
                                            ...
                                            @if($products[0]->unit_count != null)
                                                <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id" value="{{$products[0]->unit_count}}">
                                            @endif
                                            @if($products[0]->unit_count == null)
                                                <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id">
                                            @endif
                                        </div>
                                    ...
                                    <div id="grandparent">
                                        <div class="col-md-7 col-sm-6 col-xs-9 col-md-offset-2">
                                            ...
                                            @if($products[0]->sub_unit_count != null)
                                                <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id" value="{{$products[0]->sub_unit_count}}">
                                            @endif
                                            @if($products[0]->sub_unit_count == null)
                                                <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id">
                                            @endif
                                        ...
                                        <div id="grandparent">
                                            <div class="col-md-7 col-sm-6 col-xs-9 col-md-offset-2">
                                                ...
                                                @if($products[0]->productFlags[0]->title  == 'price')
                                                    <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id" value="{{number_format($products[0]->productFlags[0]->price)}}">
                                                @endif
                                                @if($products[0]->productFlags[0]->title != 'price')
                                                    <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id">
                                                @endif
                                ...
                                <div class="col-md-10 col-md-offset-1 margin-1">
                                    <div id="grandparent">
                                        ...
                                        @if($products[0]->produce_date != null)
                                            <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id" value="{{$products[0]->produce_date}}">
                                        @endif
                                        @if($products[0]->produce_date == null)
                                            <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id">
                                        @endif
                                    ...
                                    <div id="grandparent">
                                        <div class="col-md-7 col-sm-6 col-xs-9 col-md-offset-2">
                                            ...
                                            @if($products[0]->expire_date != null)
                                                <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id" value="{{$products[0]->expire_date}}">
                                            @endif
                                            @if($products[0]->expire_date == null)
                                                <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id">
                                            @endif
                                    ...
                                    <div id="grandparent">
                                        <div class="col-md-7 col-sm-6 col-xs-9 col-md-offset-2">
                                            ...
                                            @if($products[0]->produce_place != null)
                                                <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id" value="{{$products[0]->produce_place}}">
                                            @endif
                                            @if($products[0]->produce_place == null)
                                                <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id">
                                            @endif
                                    ...
                                    <div id="grandparent">
                                        <div class="col-md-7 col-sm-6 col-xs-9 col-md-offset-2">
                                            ...
                                            @if($products[0]->warehouse_count != null)
                                                <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id" value="{{$products[0]->warehouse_count}}">
                                            @endif
                                            @if($products[0]->warehouse_count == null)
                                                <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id">
                                            @endif
                                    ...
                                    <div id="grandparent">
                                        <div class="col-md-7 col-sm-6 col-xs-9 col-md-offset-2">
                                            ...
                                            @if($products[0]->warehouse_place != null)
                                                <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id" value="{{$products[0]->warehouse_place}}">
                                            @endif
                                            @if($products[0]->warehouse_place == null)
                                                <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id">
                                            @endif
                                    ...
                                    <div id="grandparent">
                                        <div class="col-md-7 col-sm-6 col-xs-9 col-md-offset-2">
                                            ...
                                            @if($products[0]->ready_time != null)
                                                <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id" value="{{$products[0]->ready_time}}">
                                            @endif
                                            @if($products[0]->ready_time == null)
                                                <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id">
                                            @endif
                                    ...
                                    <div id="grandparent">
                                        <div class="col-md-7 col-sm-6 col-xs-9 col-md-offset-2">
                                            ...
                                            @if($products[0]->barcode != null)
                                                <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id" value="{{$products[0]->barcode}}">
                                            @endif
                                            @if($products[0]->barcode == null)
                                                <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id">
                                            @endif
                                    ...
                                    <div id="grandparent">
                                        <div class="col-md-7 col-sm-6 col-xs-9 col-md-offset-2">
                                            ...
                                            @if($products[0]->discount_volume != null)
                                                <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id" value="{{$products[0]->discount_volume}}">
                                            @endif
                                            @if($products[0]->discount_volume == null)
                                                <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id">
                                            @endif
                                ...
                                <div class="col-md-10 col-md-offset-1 margin-1 margin-bot-1">
                                    ...
                                    <div class="col-md-7 col-sm-6 col-xs-9 col-md-offset-2">
                                        ...
                                        @if($products[0]->discount != null)
                                            <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id" value="{{$products[0]->discount}}">
                                        @endif
                                        @if($products[0]->discount == null)
                                            <input disabled id="editable" class="form-control col-md-7 col-xs-12 editable" name="unit_count_id">
                                        @endif
                                ...
                                <div class="col-md-10 col-md-offset-1 margin-1 margin-bot-1">
                                    ...
                                    <div class="col-md-7 col-sm-6 col-xs-9 col-md-offset-2">
                                        ...
                                        @if($products[0]->delivery_volume != null)
                                            <input disabled id="editable" class="form-control col-md-7 col-xs-10 editable" name="unit_count_id" value="{{$products[0]->delivery_volume}}">
                                        @endif
                                        @if($products[0]->delivery_volume == null)
                                            <input disabled id="editable" class="form-control col-md-7 col-xs-10 editable" name="unit_count_id">
                                        @endif
                                    </div>
                                ...
                                <div id="addPic" class="grandparent">
                                    ...
                                    @foreach($products[0]->productImages as $image)
                                        ...
                                        <div class="col-md-10 margin-1">
                                            ...
                                            <div  class="col-md-5 col-sm-6 col-xs-9 newFile" id="newFile" style="display: none;">
                                                <input   class="form-control col-md-7 col-xs-12 editable" id="editable" name="unit_count_id" type="file">
                                            </div>
                                            <div  class="col-md-5 col-sm-6 col-xs-9 showPic" id="showPic" style="display: block;">
                                                <img class="image"  id="editable" style="height: 100px; width: 100px; margin-left: 80%;" src="{{url('public/dashboard/image')}}/{{$image->image_src}}" >
                                            </div>
                                    ...
                                    <div class="col-md-10 margin-bot-1 parent">
                                        ...
                                        <div class="col-md-5 col-sm-6 col-xs-9 " >
                                            @if($products[0]->video_src != null)
                                                <video disabled="disabled"  class="form-control col-md-7 col-xs-12 editable" id="editable" name="unit_count_id" >
                                                    <source src="{{url('public/dashboard/video')}}/{{$products[0]->video_src}}">
                                                </video>
                                            @endif
                                            @if($products[0]->video_src == null)
                                                <input disabled="disabled"  class="form-control col-md-7 col-xs-12 editable" id="editable" name="unit_count_id" type="file">
                                            @endif
                                        </div>
