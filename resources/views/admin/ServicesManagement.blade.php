                    ...
                    <table style="direction:rtl;text-align: center" id="example"
                        ...
                        @foreach($services as $datum)
                            ...
                            <tr class="unit">
                                ...
                                <td style="font-size: 120%;">{{$datum->description}}</td>
                                @if($datum->active == 1)
                                ...
                                @endif
                                <td style="font-size: 120%;"><a class="btn btn-warning col-md-8 col-md-offset-2"  href="{{url('admin/editService')}}/{{$datum->id}}">ویرایش</a></td>
                            </tr>
                            {{--@endif--}}
                        @endforeach
                        </tbody>
